          ...
          <form action="{{ route('sejarah.update', $sejarah->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
              ...
              <textarea name="description" id="description"
                        class="form-control form-control-lg bg-light border-0 py-3"
                        rows="5" required>{{ $sejarah->description }}</textarea>
            </div>
            ...
            <div class="d-flex justify-content-start mt-4">
              ...
              <a href="{{ route('sejarah.index') }}" class="btn btn-primary px-4 py-2" style="background-color:#0C8CE9;">Kembali</a>
            </div>
          </form>
