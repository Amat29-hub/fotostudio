      ...
      <div class="card shadow-sm rounded-3">
        <div class="card-body">
            ...
            <table class="table align-middle mb-0">
              <thead class="bg-white">
                <tr>
                  ...
                  <th class="text-start border-0">Position</th>
              ...
              <tbody>
                ...
                <tr style="background-color:#f8f9fa;">
                  ...
                  <td class="text-start py-3">
                    <img src="{{ asset('storage/'.$tk->photo) }}" alt="photo"
                  ...
                  <td class="text-center py-3">
                    <div class="d-flex flex-column align-items-center">
                      <div class="mb-2">
                        {{-- Edit --}}
                        <a href="{{ route('tenagakerja.edit', $tk->id) }}"
          ...
          <div class="text-center mt-4">
            <a href="{{ route('tenagakerja.create') }}"
...
$(document).on('change', '.toggle-status', function() {
    ...
    $.ajax({
        url: "{{ url('adminpanel/tenagakerja') }}/" + tenagaId + "/toggle-status",
        type: "PATCH",
        data: {
            _token: "{{ csrf_token() }}",
            is_active: isActive
